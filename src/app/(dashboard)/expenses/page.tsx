    ...
    try {
      if (edit.id) {
        ...
        await supabase.from("expenses").insert({
          ...edit, id: crypto.randomUUID(), date: edit.date || new Date().toISOString().split("T")[0],
        });
      }
      setOpen(false);
      setEdit({});
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          <DialogTrigger render={<Button onClick={() => setEdit({ desc: "", amount: 0, cat: "Autre" })}><Plus className="h-4 w-4 mr-2" /> Nouvelle dépense</Button>} />
          <DialogContent>
